...
use botserver_domain::restraint::{HostRestraint, QuietHours};
...
impl BotRegistry {
    ...
    pub fn from_toml(text: &str) -> Result<Self, ConfigError> {
        ...
        for record in parsed.bots {
            ...
            let ceiling = record
                .post_ceiling
                .unwrap_or(botserver_domain::restraint::DEFAULT_POST_CEILING_24H);
            let restraint =
...
mod tests {
    ...
    fn restraint_defaults_and_overrides_load_per_bot() {
        ...
        assert_eq!(
            ...
            botserver_domain::restraint::DEFAULT_POST_CEILING_24H
        );
