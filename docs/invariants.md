...
`--envchain` flags. No test yet that binaries read `BUZZ_PRIVATE_KEY` /
`BUZZ_RELAY_URL`, or that SQLite stores no nsecs. Those MUSTs are out
of this issue's implementation scope.
